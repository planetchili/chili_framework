...
private:
	...
	void drawTexturedFlatBottomTriangle	(const texturedVertex& p0, const texturedVertex& p1, const texturedVertex& p2, const Surface& texture);
	void drawTexturedFlatTopTriangle	(const texturedVertex& p0, const texturedVertex& p1, const texturedVertex& p2, const Surface& texture);
